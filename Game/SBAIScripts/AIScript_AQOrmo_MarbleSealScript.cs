...
namespace SBAIScripts
{
    ...
    public class AIScript_AQOrmo_MarbleSealScript : AI_Script
    {
        
        [TCosReborn.Framework.Attributes.FieldCategoryAttribute(Category="AIScript_AQOrmo_MarbleSealScript")]
